...
const navItems1 = ["business", "entertainment", "general"];
const navItems2 = ["health" , "science" ,"sports" ,"technology"];
...
function DrawerAppBar(props) {
  ...
  const drawer = (
    <Box onClick={handleDrawerToggle} sx={{ textAlign: "center" }}>
      ...
      <List>
        {navItems1.map((item) => (
          <ListItem className="nav-link" href={item} key={item} disablePadding>
  ...
  return (
    <Box sx={{ display: "flex" , marginBottom : '-50px'}} className = "font">
      <CssBaseline />
